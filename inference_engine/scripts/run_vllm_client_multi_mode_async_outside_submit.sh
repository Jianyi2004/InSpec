...
# 基础配置（按需修改）
SERVER_URL="http://localhost:7878"                # 第一轮推理服务器
SUMMARY_SERVER_URL="http://localhost:5151"        # 总结服务器（可选，默认跟随 SERVER_URL）
MODEL="/data_all/share/models/Qwen3-VL-32B-Instruct"
SUMMARY_MODEL="/data_all/share/models/Qwen3-4B-Instruct-2507"
# TEST_DATA="/home/intern10/LLaMA-Factory/data/3-jiedi/all_multi.json"
TEST_DATA="/home/intern10/LLaMA-Factory/unify_final_1/data/6-inside/1224_test.json"
# PROMPT_FILE="/home/intern10/LLaMA-Factory/unify_final_1/prompts/6-outside/prompt_submit_1220.txt"
PROMPT_FILE="/home/intern10/LLaMA-Factory/unify_final_1/prompts/6-outside/prompt_icl_not_involved_v1.txt"
SYSTEM_PROMPT="/home/intern10/LLaMA-Factory/unify_final_1/prompts/6-outside/system_prompt_submit_1220.txt"
# SUMMARY_PROMPT="/home/intern10/LLaMA-Factory/unify_final_1/prompts/6-outside/summary_prompt.txt"
# SUMMARY_SYSTEM_PROMPT=""
INFERENCE_MODE="single"   # single | multi
MAX_CONCURRENT=10
TEMPERATURE=0.1
MAX_TOKENS=28000
...
OUTPUT_DIR="server_inference_results/${PROMPT_NAME}_${INFERENCE_MODE}/${TEST_DATA##*/}"
