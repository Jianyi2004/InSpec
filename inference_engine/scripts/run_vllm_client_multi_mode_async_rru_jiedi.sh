...
# 基础配置（按需修改）
SERVER_URL="http://localhost:1234"                # 第一轮推理服务器
SUMMARY_SERVER_URL="http://localhost:1234"        # 总结服务器（可选，默认跟随 SERVER_URL）
MODEL="/data_all/share/models/Qwen3-VL-32B-Instruct"
SUMMARY_MODEL="/data_all/share/models/Qwen3-VL-32B-Instruct"
TEST_DATA="/home/intern10/LLaMA-Factory/unify_final_1/data/rru_jiedi/18-RRUAAU_jiedi_4.json"
PROMPT_FILE="/home/intern10/LLaMA-Factory/unify_final_1/prompts/rru_jiedi/prompt_instruct_v1.txt"
# SYSTEM_PROMPT="/home/intern10/LLaMA-Factory/unify_final_1/prompts/6-outside/system_prompt_v5.txt"
SUMMARY_PROMPT="/home/intern10/LLaMA-Factory/unify_final_1/prompts/rru_jiedi/prompt_sumup_instruct_v1.txt"
...
OUTPUT_DIR="server_inference_results/${SYSTEM_PROMPT##*/}/${PROMPT_NAME}/${SUMMARY_PROMPT##*/}/${TEST_DATA##*/}"
