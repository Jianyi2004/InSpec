...
# SUMMARY_SERVER_URL="http://localhost:3333"        # 总结服务器（可选，默认跟随 SERVER_URL）
...
TEST_DATA="/home/intern10/LLaMA-Factory/unify_final_1/data/5-inside/output_old.json"
PROMPT_FILE="/data_all/share/Huawei/SUBMIT_0114/机柜内密封/prompt/inside_icl_v10.txt"
SYSTEM_PROMPT="/data_all/share/Huawei/SUBMIT_0114/机柜内密封/prompt/system_prompt_v1.txt"
SUMMARY_PROMPT="/data_all/share/Huawei/SUBMIT_0114/机柜内密封/prompt/summary_prompt.txt"
